export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx8727ad859b7b88bc",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "5e89ce86c97f35b6d51f6ffa7e98ae98",
  ...
  USERS: [
    {
      ...
      id: "oOHed6Z3CNyeQ-Y7WMQ0jdz4EEd8",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "bXmIf9Dt_yJaraVnFg-hTq1Hs0OSyaqIQoi8Ay3JsBw",
      // 所在省份
      province: "河北",
      // 所在城市
      city: "保定",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "000", "year": "1996", "date": "09-09"},
        {"type": "节日", "name": "结婚纪念日", "year": "2020", "date": "09-03"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "小朋友", "year": "2005", "date": "03-18"},
        {"type": "节日", "name": "被搭讪纪念日", "year": "2021", "date": "09-13"},
      ],
